 ...
 if ($_SERVER['REQUEST_METHOD'] === 'GET') {
     ...
     define('DB_PASSWORD', '');
     define('DB_NAME', 'csci_fullstack_project');
...
<div class=\"card-wrapper\">
    <a href=\"add-card/index.php?card_id=$row[0]&method=update\" class=\"edit\"><i class=\"fas fa-edit\"></i></a>
    <a href=\"add-card/index.php?card_id=$row[0]&method=delete\" class=\"delete\"><i class=\"fas fa-trash\"></i></a>
    <a href=\"$row[2]\">
    <article>
